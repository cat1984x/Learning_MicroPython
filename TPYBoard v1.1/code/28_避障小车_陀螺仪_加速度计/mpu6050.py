...
class PyComms:
  def __init__(self, address=0x69, side=1): #浮空地址为69
...
class MPU6050:    
    ...
    MPU6050_ADDRESS_AD0_HIGH      = 0x69 # address pin high (VCC) or float 浮空 
    MPU6050_DEFAULT_ADDRESS       = MPU6050_ADDRESS_AD0_HIGH
